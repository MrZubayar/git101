function generate_basic_plots(filter_name, filtered_signal, signal, P, original_signal, selected_signal_type, noise_level)
    % Calculate mean, bias, variance, and standard deviation
    ...
    % Begin plotting and saving figures
    ...
    fprintf('Basic plots for noise level %.2f have been saved.\n', noise_level);
end
