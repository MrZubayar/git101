function plot_difference_metric_noisy(metric_values, M_values)
    ...
    title('Mean Absolute Difference between Filtered and Noisy Signals across M Values');
    xlabel('M Value');
    ...
    legend([h_individual, h_mean], {'Individual Realizations', 'Mean Difference'}, 'Location', 'northeast');
