function execute_analysis(selected_filtering_technique, selected_signal_type, noise_level, quality_metrics, WANT_FIGSAVE, noise_level_vector)
    ...
    % Generate plots and metrics for Lee filter
    if ~isempty(filtered_signal)
        generate_plots_for_filter(selected_filtering_technique, filtered_signal, signal, P, original_signal, selected_signal_type, noise_level, noise_level_vector, quality_metrics);
    end
